      ...
      <div className="pl-6 pr-5">
        ...
        <div className="mt-8 flex flex-col xl:flex-row xl:items-center xl:mt-24">
          <div className="xl:max-w-[600px]">
            ...
            <div className=" mt-3 font-Poppins text-[12px] font-normal leading-5 text-gray-600 sm:text-[13px] xl:text-[16px] xl:leading-8">
              <p>
                Tabitha Alms has mitigated human suffering and impacted lives of
                its beneficiaries through the following ongoing activities:
                Providing feeding program of needy children and families,
                economic empowerment and psychosocial support of widows, single
                mothers, and teenage mothers
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 xl:mt-24 flex flex-col-reverse xl:flex-row-reverse xl:items-center ">
          <div className="xl:pl-6 xl:max-w-[600px]">
            ...
            <div className=" mt-1 font-Poppins text-[12px] font-normal leading-5 text-gray-600 sm:text-[13px] xl:text-[16px] xl:leading-8 ">
              <p>
                Education of identified needy learners pupils in primary schools
                and students in secondary schools through paying of school fees
                and providing necessary support for learners
              </p>
            </div>
          </div>
          <div className="mt-6 relative h-[220px] xl:h-[400px] w-full rounded-lg">
        ...
        <div className="mt-8 xl:mt-24 flex flex-col xl:flex-row-reverse xl:items-center xl:justify-between ">
          <div className="xl:max-w-[600px] xl:pl-6">
            ...
            <div className=" mt-1 font-Poppins text-[12px] font-normal leading-5 text-gray-600 sm:text-[13px]">
              <p className="xl:text-[16px] xl:leading-8 ">
                The department also carries out community outreach program which
                ...
                program for street children , street families and other needy
                people and cloth donation for needy people.
              </p>
            </div>
          </div>
          <div className="mt-6 relative h-[220px] xl:h-[400px] w-full rounded-lg">
          ...
          <div className="max-w-[600px]">
            ...
            <div className=" mt-1 font-Poppins text-[12px] font-normal leading-5 text-gray-600 sm:text-[13px]">
              <p className="xl:text-[16px] xl:leading-8 xl:pr-6">
                ...
                beauty parlor services during outreach program to inspire and
                show love to the needy who do not have resources to access such
                services. Tabitha Alms as well supports various church
                leaders/laborers across churches in meeting their needs as they
                do the work of ministry and get involved in service to humanity.
              </p>
            </div>
          </div>
          <div className="mt-6 relative h-[220px] xl:h-[400px] w-full rounded-lg">
        ...
        <div className="mt-8 text-center xl:mt-24">
          <h3 className="font-Magenda sm:text-[24px] font-bold">Our Vision</h3>
